...
namespace ConsoleApp1._2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string crisps = Console.ReadLine(); // не получается ввести дробные числа типа 123.45. 
            double c = Convert.ToInt32(crisps);
            Console.WriteLine("Введите цену Хлеба");
            string bread = Console.ReadLine();
            double b = Convert.ToInt32(bread);
            Console.WriteLine("Введите цену Воды 5л");
            string water = Console.ReadLine();
            double w = Convert.ToInt32(water);
            Console.WriteLine("Введите сумму для оплаты");
            string price = Console.ReadLine();
            double M = Convert.ToInt32(price);
            ...
            Console.WriteLine("НАЛИЧНЫМИ                                                      =" + Nn);
                Console.WriteLine("ПОЛУЧЕНО НАЛИЧНЫМИ                                             =" + M); // Так же не получается прервать операцию, если сумму полученных денег, меньше необходимой суммы для оплаты
                ...
                Console.WriteLine("OOO Розница К-1"); // не понял как сделать, чтобы в консоле выводилось название организации в " кавычках "
...
// Подскажите пожалуйста, как должен был выглядеть в правильно варианте код который я записал. И по возможности дайте пример идеального построения кода, возможно из ДЗ других ребят
// К сожалению у меня очень мало времени, я толком телеграмм не смотрю что там люди пишут... поговорить с ними так времени совсем нет. Очень надеюсь на обратную связь.
